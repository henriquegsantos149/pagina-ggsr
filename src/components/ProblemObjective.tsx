      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <h2 className="text-2xl sm:text-3xl md:text-5xl font-bold mb-8 font-primary uppercase leading-tight">
          ...
          <motion.div
            ...
            className="shape-leaf bg-white border border-slate-200/80 shadow-lg shadow-slate-200/50 p-10 relative overflow-hidden"
          >
            ...
            <div className="space-y-8">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-bold text-[var(--color-brand-dark)] mb-1 uppercase tracking-wider text-sm">Autoridade Técnica</h4>
                  <p className="text-[var(--color-brand-dark)]/70 text-sm">Capacitar você para atuar com 100% de confiança em geotecnologias de ponta.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-bold text-[var(--color-brand-dark)] mb-1 uppercase tracking-wider text-sm">Resultados Práticos</h4>
                  <p className="text-[var(--color-brand-dark)]/70 text-sm">Garantir que cada módulo se traduza em uma nova habilidade monetizável no mercado.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                <div className="mt-1 w-2 h-2 rounded-full bg-[var(--color-brand-secondary)] shrink-0 shadow-[0_0_10px_var(--color-brand-secondary)]"></div>
                <div>
                  <h4 className="font-bold text-[var(--color-brand-dark)] mb-1 uppercase tracking-wider text-sm">Conformidade Legal</h4>
                  <p className="text-[var(--color-brand-dark)]/70 text-sm">Dominar as exigências regulatórias para emissão de laudos e certificações oficiais.</p>
                </div>
              </div>
            </div>
